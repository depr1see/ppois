...
@dataclass
class TellerCashDrawer:
    drawer_id: str = ""
    cash_level: float = 0.0
    branch: Branch | None = None

    def update_teller_cash_drawer(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_teller_cash_drawer(self) -> str:
        parts = []
        ...
        return f"TellerCashDrawer[" + ", ".join(parts) + "]"
