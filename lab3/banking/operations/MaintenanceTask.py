...
class MaintenanceTask:
    ...
    target_atm: ATM | None = None

    def update_maintenance_task(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_maintenance_task(self) -> str:
        parts = []
        ...
        return f"MaintenanceTask[" + ", ".join(parts) + "]"
