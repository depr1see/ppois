...
class PaymentRequest:
    ...
    def update_payment_request(self, note: str = "", delta: float | None = None) -> str:
        if note and (not self.merchant or self.account is None):
            raise PaymentRejectedException("Payment request missing merchant or account.")
    ...
    def describe_payment_request(self) -> str:
        parts = []
        ...
        return f"PaymentRequest[" + ", ".join(parts) + "]"
