...
class StandingInstruction:
    ...
    def update_standing_instruction(self, note: str = "", delta: float | None = None) -> str:
        if note and (not self.account or not self.frequency):
            raise InvalidScheduleException("Standing instruction lacks account or frequency.")
    ...
    def describe_standing_instruction(self) -> str:
        parts = []
        ...
        return f"StandingInstruction[" + ", ".join(parts) + "]"
