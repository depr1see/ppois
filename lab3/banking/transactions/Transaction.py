...
class Transaction:
    ...
    def update_transaction(self, note: str = "", delta: float | None = None) -> str:
        if note and (self.amount <= 0 or self.source_account is None):
            raise PaymentRejectedException("Transaction requires positive amount and source account.")
