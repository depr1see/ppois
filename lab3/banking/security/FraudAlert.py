...
class FraudAlert:
    ...
    def update_fraud_alert(self, note: str = "", delta: float | None = None) -> str:
        if getattr(self, 'severity', '').lower() == 'high':
            raise FraudDetectedException("High severity alert raised.")
    ...
    def describe_fraud_alert(self) -> str:
        parts = []
        ...
        return f"FraudAlert[" + ", ".join(parts) + "]"
