...
class SecurityPolicy:
    policy_id: str = ""
    description: str = ""
    applies_to: list[BankAccount] = field(default_factory=list)

    def update_security_policy(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_security_policy(self) -> str:
        ...
        return f"SecurityPolicy[" + ", ".join(parts) + "]"
