...
class SanctionsScreening:
    ...
    def update_sanctions_screening(self, note: str = "", delta: float | None = None) -> str:
        if self.customer is None:
            raise UnauthorizedAccessException("Customer missing for sanctions screening.")
    ...
    def describe_sanctions_screening(self) -> str:
        parts = []
        ...
        return f"SanctionsScreening[" + ", ".join(parts) + "]"
