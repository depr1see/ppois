...
class AuditTrail:
    ...
    resource_owner: Customer | None = None

    def update_audit_trail(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_audit_trail(self) -> str:
        parts = []
        ...
        return f"AuditTrail[" + ", ".join(parts) + "]"
