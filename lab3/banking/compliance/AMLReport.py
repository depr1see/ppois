...
from banking.exceptions import AMLFlaggedException, LimitExceededException, OverdraftException
...
class AMLReport:
    ...
    def update_aml_report(self, note: str = "", delta: float | None = None) -> str:
        if self.flagged:
            raise AMLFlaggedException("AML alert flagged this account.")
    ...
    def describe_aml_report(self) -> str:
        parts = []
