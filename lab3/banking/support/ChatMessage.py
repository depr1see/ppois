...
class ChatMessage:
    message_id: str = ""
    content: str = ""
    sender: Customer | None = None

    def update_chat_message(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_chat_message(self) -> str:
        parts = []
        ...
        return f"ChatMessage[" + ", ".join(parts) + "]"
