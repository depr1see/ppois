...
from banking.exceptions import FraudDetectedException, LimitExceededException, OverdraftException
...
class IncidentReport:
    ...
    def update_incident_report(self, note: str = "", delta: float | None = None) -> str:
        if 'fraud' in self.details.lower():
            raise FraudDetectedException("Fraudulent incident reported.")
    ...
    def describe_incident_report(self) -> str:
        parts = []
        ...
        return f"IncidentReport[" + ", ".join(parts) + "]"
