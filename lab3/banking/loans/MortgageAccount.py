...
class MortgageAccount:
    ...
    borrower: Customer | None = None

    def update_mortgage_account(self, note: str = "", delta: float | None = None) -> str:
        if note and self.borrower is None:
            raise LoanDefaultException("Borrower is required for mortgage.")
    ...
    def describe_mortgage_account(self) -> str:
        parts = []
        ...
        return f"MortgageAccount[" + ", ".join(parts) + "]"
