...
class Beneficiary:
    name: str = ""
    relation: str = ""
    target_account: BankAccount | None = None

    def update_beneficiary(self, note: str = "", delta: float | None = None) -> str:
    ...
    def describe_beneficiary(self) -> str:
        parts = []
        ...
        return f"Beneficiary[" + ", ".join(parts) + "]"
