...
class CheckingAccount:
    account_number: str = ""
    balance: float = 0.0
    primary_holder: Customer | None = None

    def update_checking_account(self, note: str = "", delta: float | None = None) -> str:
        if delta is not None and delta < 0:
            raise OverdraftException("Negative adjustments require overdraft review.")
    ...
    def describe_checking_account(self) -> str:
        parts = []
        ...
        return f"CheckingAccount[" + ", ".join(parts) + "]"
