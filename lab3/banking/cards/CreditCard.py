...
class CreditCard:
    ...
    def update_credit_card(self, note: str = "", delta: float | None = None) -> str:
        if delta is not None and delta < 0:
            raise PaymentRejectedException("Credit adjustments cannot be negative.")
    ...
    def describe_credit_card(self) -> str:
        parts = []
        ...
        return f"CreditCard[" + ", ".join(parts) + "]"
